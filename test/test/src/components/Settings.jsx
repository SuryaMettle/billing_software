...
<div style={{ marginTop: "36px" }}>
  <div style={{
    ...
    <div>
      ...
      <div style={{ fontSize: 13, color: "#666" }}>
        Save or export a copy of your data
      </div>
    </div>
  </div>
  ...
  <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
    <button
      ...
      style={{
        ...
        fontWeight: 700,
        fontSize: 16,
        boxShadow: backupLoading ? "none" : "0 12px 32px rgba(102,126,234,0.4)"
      }}
    >
    ...
    <button
      ...
      style={{
        ...
        fontWeight: 700,
        fontSize: 16,
        boxShadow: exportLoading ? "none" : "0 12px 32px rgba(76,175,80,0.4)"
      }}
    >
